import {addEventListener, removeEventListener, getNextHighestZIndex} from './utils';
...
export default class Board {
    ...
    constructor(inputConfig) {
        ...
        this.GRID_FOOD_VALUE = -1, // the value of a spot on the board that represents snake food, MUST BE NEGATIVE
        this.myFood = myFood
        mySnake,
    ...
    */
    getClientHeight(window) {
        ...
        createBoardElements() {
            ...
            addEventListener(elmPlayingField, "click", function () {
                elmContainer.focus();
            }, false);
            ...
            addEventListener(elmContainer, "keyup", function (evt) {
        ...
        function createWelcomeElement() {
            ...
            addEventListener(window, "keyup", kbShortcut, false);
            addEventListener(welcomeStart, "click", loadGame, false);
        ...
        function createTryAgainElement() {
            ...
            addEventListener(window, "keyup", kbTryAgainShortcut, true);

            addEventListener(tryAgainStart, "click", reloadGame, false);
        ...
        */
        me.resetBoard = function () {
            removeEventListener(elmContainer, "keydown", myKeyListener, false);
            mySnake.reset();
            elmLengthPanel.innerHTML = "Score: 1";
        ...
        me.setupPlayingField = function () {
            ...
            myKeyListener = function (evt) {
                ...
                if (me.getBoardState() === 1) {
                    ...
                    addEventListener(elmContainer, "keydown", myKeyListener, false);
